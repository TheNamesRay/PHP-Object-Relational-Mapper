PHP + MySQL ORM
=====================
[![Build Status](https://scrutinizer-ci.com/g/KuntaProject/ORMLight/badges/build.png?b=master)](https://scrutinizer-ci.com/g/KuntaProject/ORMLight/build-status/master)
